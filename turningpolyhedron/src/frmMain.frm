...
With FakeDXUIControls(1)
 ...
 With .AddNewChildren(FakeCtl_Form, 40, 80, 560, 440, &HFFFFFF, , , , "Form1234°¡°¢")
  ...
  "Text1 blah blak blah blah blah xxxxxxxxxxxxxx yyyyyyyyy zzzzzz" + vbCrLf + "xxx" + vbCrLf + "xxx" + vbCrLf + "xxx" + vbCrLf + vbCrLf + "xxx" + vbCrLf + String(50, "°¡"))
   .ScrollBars = vbBoth
   .MultiLine = True
  End With
 ...
 With .AddNewChildren(FakeCtl_Form, 240, 200, 480, 360, &HFFFFFF, , , , "É½Õ¯MDIForm1")
  ...
  3& Or FFS_TitleBar Or FFS_CloseButton Or FFS_MaxButton Or FFS_MinButton, , , , "Form2")
   ...
   Replace(Space(100), " ", "Text2 blah blah blah °¡°¡°¡°¡°¡°¡°¢°¡°¡°¡°¡°¡°¡°¡°¡°¡°¡°¡°¡ blah blah blah" + vbCrLf), , , , 1, 1)
